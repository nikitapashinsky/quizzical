...
export default function Answer({
  ...
  return (
    <li className="">
      ...
      <label
        htmlFor={answer.id}
        className="flex h-14 cursor-pointer items-center justify-center rounded-[16px] border-[3px] border-gray-900 bg-white px-4 font-medium shadow-[0_3px_0_#111827] transition-all hover:-translate-y-[2px] hover:shadow-[0_5px_0_#111827] active:translate-y-[2px] active:shadow-[0_1px_0_#111827] peer-checked:translate-y-[4px] peer-checked:bg-gray-200
        peer-checked:shadow-[inset_0_2px_0_#111827]
        peer-checked:hover:translate-x-0 peer-checked:hover:translate-y-0
